...
<html lang="zh-cn">
  <head>
    ...
    <link href="${baseUrlStatic}/css/test/mylove.css" rel="stylesheet">
  </head>
  ...
  <body>
    ...
    <script type="text/javascript" src="${baseUrlStatic}/js/test/mylove.js"></script>
    <script type="text/javascript" src="${baseUrlStatic}/js/test/mylove-function.js"></script>
